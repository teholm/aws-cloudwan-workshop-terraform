...
# Firewall Policy to apply in ohio (us-east-2)
resource "aws_networkfirewall_firewall_policy" "ohio_fwpolicy" {
  ...
  firewall_policy {
    ...
    stateless_fragment_default_actions = ["aws:forward_to_sfe"]
    stateful_rule_group_reference {
      resource_arn = aws_networkfirewall_rule_group.icmp_alert_stateful_rule_group_ohio.arn
    }
    stateful_rule_group_reference {
      resource_arn = aws_networkfirewall_rule_group.domain_allow_stateful_rule_group_ohio.arn
    }
  }
}

resource "aws_networkfirewall_rule_group" "icmp_alert_stateful_rule_group_ohio" {
  provider = aws.awsohio
...
resource "aws_networkfirewall_rule_group" "domain_allow_stateful_rule_group_ohio" {
  provider = aws.awsohio
