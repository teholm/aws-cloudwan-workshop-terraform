...
| [aws_ec2_transit_gateway.ohio_tgw](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway) | resource |
...
| [aws_ec2_transit_gateway_route_table.ohio_tgw_rt](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_route_table) | resource |
...
| [aws_ec2_transit_gateway_route_table_association.ohio_tgw_rt_association](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_route_table_association) | resource |
...
| [aws_ec2_transit_gateway_route_table_propagation.ohio_tgw_rt_propagation](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ec2_transit_gateway_route_table_propagation) | resource |
...
| [aws_networkfirewall_firewall_policy.ohio_fwpolicy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/networkfirewall_firewall_policy) | resource |
...
| [aws_networkfirewall_rule_group.domain_allow_stateful_rule_group_ohio](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/networkfirewall_rule_group) | resource |
...
| [aws_networkfirewall_rule_group.icmp_alert_stateful_rule_group_ohio](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/networkfirewall_rule_group) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_aws_regions"></a> [aws\_regions](#input\_aws\_regions) | AWS regions to spin up resources. | `map(string)` | <pre>{<br>  "oregon": "us-west-2",<br>  "ohio": "us-east-2"<br>}</pre> | no |
...
| <a name="input_oregon_legacy_vpc"></a> [oregon\_legacy\_vpc](#input\_oregon\_legacy\_vpc) | Information about the Legacy VPC to create in us-west-2. | `any` | <pre>{<br>  "cidr_block": "10.2.0.0/16",<br>  "endpoint_subnet_cidrs": [<br>    "10.2.3.0/28",<br>    "10.2.3.16/28",<br>    "10.2.3.32/28"<br>  ],<br>  "instance_type": "t3.nano",<br>  "name": "legacy-us-west-2",<br>  "number_azs": 2,<br>  "tgw_subnet_cidrs": [<br>    "10.2.3.48/28",<br>    "10.2.3.64/28",<br>    "10.2.3.80/28"<br>  ],<br>  "workload_subnet_cidrs": [<br>    "10.2.0.0/24",<br>    "10.2.1.0/24",<br>    "10.2.2.0/24"<br>  ]<br>}</pre> | no |
| <a name="input_oregon_spoke_vpcs"></a> [oregon\_spoke\_vpcs](#input\_oregon\_spoke\_vpcs) | Information about the VPCs to create in us-west-2. | `any` | <pre>{<br>  "non-prod": {<br>    "cidr_block": "10.1.0.0/16",<br>    "cnetwork_subnet_cidrs": [<br>      "10.1.3.48/28",<br>      "10.1.3.64/28",<br>      "10.1.3.80/28"<br>    ],<br>    "endpoint_subnet_cidrs": [<br>      "10.1.3.0/28",<br>      "10.1.3.16/28",<br>      "10.1.3.32/28"<br>    ],<br>    "instance_type": "t3.nano",<br>    "name": "non-prod-us-west-2",<br>    "number_azs": 2,<br>    "type": "nonprod",<br>    "workload_subnet_cidrs": [<br>      "10.1.0.0/24",<br>      "10.1.1.0/24",<br>      "10.1.2.0/24"<br>    ]<br>  },<br>  "prod": {<br>    "cidr_block": "10.0.0.0/16",<br>    "cnetwork_subnet_cidrs": [<br>      "10.0.3.48/28",<br>      "10.0.3.64/28",<br>      "10.0.3.80/28"<br>    ],<br>    "endpoint_subnet_cidrs": [<br>      "10.0.3.0/28",<br>      "10.0.3.16/28",<br>      "10.0.3.32/28"<br>    ],<br>    "instance_type": "t3.nano",<br>    "name": "prod-us-west-2",<br>    "number_azs": 2,<br>    "type": "prod",<br>    "workload_subnet_cidrs": [<br>      "10.0.0.0/24",<br>      "10.0.1.0/24",<br>      "10.0.2.0/24"<br>    ]<br>  }<br>}</pre> | no |
...
| <a name="input_ohio_inspection_vpc"></a> [ohio\_inspection\_vpc](#input\_ohio\_inspection\_vpc) | Information about the Inspection VPC to create in us-east-2. | `any` | <pre>{<br>  "cidr_block": "100.64.0.0/16",<br>  "cnetwork_subnet_cidrs": [<br>    "100.64.0.96/28",<br>    "100.64.0.112/28",<br>    "100.64.0.128/28"<br>  ],<br>  "inspection_subnet_cidrs": [<br>    "100.64.0.48/28",<br>    "100.64.0.64/28",<br>    "100.64.0.80/28"<br>  ],<br>  "name": "inspection-us-east-2",<br>  "number_azs": 2,<br>  "public_subnet_cidrs": [<br>    "100.64.0.0/28",<br>    "100.64.0.16/28",<br>    "100.64.0.32/28"<br>  ]<br>}</pre> | no |
| <a name="input_ohio_legacy_vpc"></a> [ohio\_legacy\_vpc](#input\_ohio\_legacy\_vpc) | Information about the Legacy VPC to create in us-west-2. | `any` | <pre>{<br>  "cidr_block": "10.12.0.0/16",<br>  "endpoint_subnet_cidrs": [<br>    "10.12.3.0/28",<br>    "10.12.3.16/28",<br>    "10.12.3.32/28"<br>  ],<br>  "instance_type": "t3.nano",<br>  "name": "legacy-us-west-2",<br>  "number_azs": 2,<br>  "tgw_subnet_cidrs": [<br>    "10.12.3.48/28",<br>    "10.12.3.64/28",<br>    "10.12.3.80/28"<br>  ],<br>  "workload_subnet_cidrs": [<br>    "10.12.0.0/24",<br>    "10.12.1.0/24",<br>    "10.12.2.0/24"<br>  ]<br>}</pre> | no |
| <a name="input_ohio_spoke_vpcs"></a> [ohio\_spoke\_vpcs](#input\_ohio\_spoke\_vpcs) | Information about the VPCs to create in us-east-2. | `any` | <pre>{<br>  "non-prod": {<br>    "cidr_block": "10.11.0.0/16",<br>    "cnetwork_subnet_cidrs": [<br>      "10.11.3.48/28",<br>      "10.11.3.64/28",<br>      "10.11.3.80/28"<br>    ],<br>    "endpoint_subnet_cidrs": [<br>      "10.11.3.0/28",<br>      "10.11.3.16/28",<br>      "10.11.3.32/28"<br>    ],<br>    "instance_type": "t3.nano",<br>    "name": "non-prod-us-east-2",<br>    "number_azs": 2,<br>    "type": "nonprod",<br>    "workload_subnet_cidrs": [<br>      "10.11.0.0/24",<br>      "10.11.1.0/24",<br>      "10.11.2.0/24"<br>    ]<br>  },<br>  "prod": {<br>    "cidr_block": "10.10.0.0/16",<br>    "cnetwork_subnet_cidrs": [<br>      "10.10.3.48/28",<br>      "10.10.3.64/28",<br>      "10.10.3.80/28"<br>    ],<br>    "endpoint_subnet_cidrs": [<br>      "10.10.3.0/28",<br>      "10.10.3.16/28",<br>      "10.10.3.32/28"<br>    ],<br>    "instance_type": "t3.nano",<br>    "name": "prod-us-east-2",<br>    "number_azs": 2,<br>    "type": "prod",<br>    "workload_subnet_cidrs": [<br>      "10.10.0.0/24",<br>      "10.10.1.0/24",<br>      "10.10.2.0/24"<br>    ]<br>  }<br>}</pre> | no |
| <a name="input_transit_gateway_asn"></a> [transit\_gateway\_asn](#input\_transit\_gateway\_asn) | Transit Gateway ASNs. | `map(number)` | <pre>{<br>  "oregon": 64515,<br>  "ohio": 64516<br>}</pre> | no |
