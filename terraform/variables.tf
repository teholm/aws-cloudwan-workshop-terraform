...
# Definition of the VPCs to create in ohio Region
variable "ohio_spoke_vpcs" {
  type        = any
  description = "Information about the VPCs to create in us-east-2."

  default = {
    "non-prod" = {
      type                  = "nonprod"
      name                  = "non-prod-us-east-2"
      number_azs            = 2
...
variable "ohio_inspection_vpc" {
  type        = any
  description = "Information about the Inspection VPC to create in us-east-2."

  default = {
    name                    = "inspection-us-east-2"
    cidr_block              = "100.64.0.0/16"
    public_subnet_cidrs     = ["100.64.0.0/28", "100.64.0.16/28", "100.64.0.32/28"]
    inspection_subnet_cidrs = ["100.64.0.48/28", "100.64.0.64/28", "100.64.0.80/28"]
    cnetwork_subnet_cidrs   = ["100.64.0.96/28", "100.64.0.112/28", "100.64.0.128/28"]
